...
curl --user user:[REDACTED] --data-binary '{"jsonrpc": "1.0", "id":"0", "method": "getinfo", "params": [] }' -H 'content-type: text/plain;' http://127.0.0.1:22555/
cd ..


docker run -d --rm  -p 8332:8332 ruimarinho/bitcoin-core -printtoconsole -server -rest -regtest=1 -rpcport=8332 -rpcallowip=0.0.0.0/0  -rpcpassword=[REDACTED] -rpcuser=user