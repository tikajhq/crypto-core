...
pm2 start --no-autorestart ./dcr/dcrd             -- --txindex  --rpclisten=0.0.0.0 --rpcpass=s3cur3 --rpcuser=dcr
...
pm2 start --no-autorestart geth                 -- --cache=2048 --fast --rpc --rpcaddr=0.0.0.0 --rpcport=8545 --ws --wsaddr=0.0.0.0 --wsport=8546 --wsorigins "*"
